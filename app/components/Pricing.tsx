            ...
            <div className="flex-1 xl:mx-8">
              <div className="mt-8 space-y-8 md:-mx-4 md:flex md:items-center md:justify-center md:space-y-0 xl:mt-0">
                <div className="max-w-sm mx-auto border rounded-lg md:mx-4 dark:border-gray-700">
                  <div className="p-6">
                    <h1 className="text-xl font-medium text-white capitalize lg:text-2xl ">
                      Essential
                    </h1>
                ...
                <div className="max-w-sm mx-auto border rounded-lg md:mx-4 dark:border-gray-700">
                  <div className="p-6">
                    <h1 className="text-xl font-medium text-white capitalize lg:text-2xl dark:text-white">
                      Premium
                    </h1>
                    ...
                    <p className="mt-1 text-white ">One time payment</p>
                  ...
                  <div className="p-6">
                    <h1 className="text-lg font-medium text-white capitalize lg:text-xl dark:text-white">
                      What’s included:
                    </h1>
